...
class Encuesta_2 extends StatefulWidget {
  const Encuesta_2({Key? key}) : super(key: key);

  @override
  State<Encuesta_2> createState() => _Encuesta_2State();
}

class _Encuesta_2State extends State<Encuesta_2> {
  @override
